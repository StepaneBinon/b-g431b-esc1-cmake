...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, CAN_TERM_Pin|STATUS_Pin|BUTTON_Pin|CAN_SHDN_TP2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIO_BEMF_GPIO_Port, GPIO_BEMF_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : CAN_TERM_Pin STATUS_Pin BUTTON_Pin CAN_SHDN_TP2_Pin */
  GPIO_InitStruct.Pin = CAN_TERM_Pin|STATUS_Pin|BUTTON_Pin|CAN_SHDN_TP2_Pin;
