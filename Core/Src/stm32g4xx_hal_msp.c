...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = A___POTENTIOMETER_Pin|Temperature_feedback_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, A___POTENTIOMETER_Pin|Temperature_feedback_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VINM0
    */
    GPIO_InitStruct.Pin = Curr_fdbk1_OPAmp__Pin|OP1_OUT_Pin|Curr_fdbk1_OPAmp_A3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PA7     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = Curr_fdbk2_OPAmp__Pin|OP2_OUT_Pin|Curr_fdbk2_OPAmp_A7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  else if(hopamp->Instance==OPAMP3)
  {
    ...
    PB2     ------> OPAMP3_VINM0
    */
    GPIO_InitStruct.Pin = Curr_fdbk3_OPAmp__Pin|TP3_Pin|Curr_fdbk3_OPAmp_B2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VINM0
    */
    HAL_GPIO_DeInit(GPIOA, Curr_fdbk1_OPAmp__Pin|OP1_OUT_Pin|Curr_fdbk1_OPAmp_A3_Pin);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PA7     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(GPIOA, Curr_fdbk2_OPAmp__Pin|OP2_OUT_Pin|Curr_fdbk2_OPAmp_A7_Pin);
  ...
  else if(hopamp->Instance==OPAMP3)
  {
    ...
    PB2     ------> OPAMP3_VINM0
    */
    HAL_GPIO_DeInit(GPIOB, Curr_fdbk3_OPAmp__Pin|TP3_Pin|Curr_fdbk3_OPAmp_B2_Pin);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  else if(htim_ic->Instance==TIM4)
  {
    ...
    PB8-BOOT0     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = A__H1_Pin|B__H2_Pin|Z__H3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  else if(htim_ic->Instance==TIM4)
  {
    ...
    PB8-BOOT0     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOB, A__H1_Pin|B__H2_Pin|Z__H3_Pin);
